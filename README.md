...
### 🛠️ The Hackers Toolkit

| Category | Tools & Technologies |
| :--- | :--- |
| **OS / Shell** | Linux (Kali Linux, Ubuntu), Bash Scripting |
| **Recon & Scanning** | Nmap, Wireshark, Dirbuster |
| **Exploitation** | Metasploit Framework, Burp Suite, OWASP Top 10 |
| **Programming** | Python (Automation Scripts), Bash |
